#ifndef DETECT_THREAD_2_H
#define DETECT_THREAD_2_H
#include <QThread>
#include <string>
#include <QString>
#include "global.h"
...
Q_DECLARE_METATYPE(Data_2);
class detect_thread_2 : public QThread
{
    Q_OBJECT
...
public:
    ...
    void run();
    int detect_fun_thread_2(BitSequence* bits,int len);

private:
    Data_2 data_2;

signals:
    void Send2UI_2(Data_2 data_2);
};

#endif // DETECT_THREAD_2_H
