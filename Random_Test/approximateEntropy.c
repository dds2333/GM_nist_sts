...
extern double ApproximateEntropy_p_Value;
extern double ApproximateEntropy_v_Value;
...
//				fprintf(stats[TEST_APEN], "ApEn:  Insufficient memory available.\n");
    ...
    ApproximateEntropy_p_Value=p_value;
    ApproximateEntropy_v_Value=chi_squared;
